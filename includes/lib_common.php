...
function load_config()
{
    ...
    if ($data === false)
    {
        ...
        $arr['article_number']       = intval($arr['article_number'])  > 0 ? intval($arr['article_number'])  : 12;
 ...
 * @return  void
 */
function build_uricx($app, $params, $append = '', $page = 0, $keywords = '', $size = 0)
{
 ...
 * @return  void
 */
function build_urippt($app, $params, $append = '', $page = 0, $keywords = '', $size = 0)
{
	...
	{
		case 'category':
				$uri = 'basicppt.php?act=addsp&id='.$cid;
				if (!empty($bid))
				{
					$uri .= '&amp;brand=' . $bid;
				}
 ...
 * @return  void
 */
function build_uriallppt($app, $params, $append = '', $page = 0, $keywords = '', $size = 0)
{
	...
	{
		case 'category':
				$uri = 'basicppt.php?act=addsp&id=0';
				if (!empty($bid))
				{
					$uri .= '&amp;brand=' . $bid;
				}
 ...
 * @return  void
 */
function build_uriall($app, $params, $append = '', $page = 0, $keywords = '', $size = 0)
{

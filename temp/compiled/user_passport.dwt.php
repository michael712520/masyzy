...
<div class="usBox clearfix">
  <div class="usBox_1 f_l">
   ...
   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()" >
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5" style="font-size: 14px;">
          <tr>
          ...
          <tr>
            ...
            <input type="submit" name="submit" value="立即登陆" class="us_Submit_wz" />
            </td>
          </tr>
  ...
  <div style="padding-left:50px;">
    ...
    <a href="user.php?act=register" class="us_cz">会员注册</a>
  </div>
   </div>
</div>
<?php endif; ?>
	...
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <?php endif; ?>
        ...
        <tr>
          ...
          <input type="hidden" name="back_act" value="<?php echo $this->_var['back_act']; ?>" />
          <input name="Submit" type="submit" value="会员注册" class="flow_Submit_wz">
          </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>

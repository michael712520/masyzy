...
<script type="text/javascript" src="themes/ecmoban_jindong2013/js/action.js"></script>
...
<div class="block clearfix">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
     <a href="<?php echo $this->_var['pictures']['0']['img_url']; ?>" id="zoom1" class="MagicZoom MagicThumb" title="<?php echo $this->_var['goods']['goods_style_name']; ?>" target="_blank">
      <img src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" width="409px;" height="409px"/>
     </a>
     <div class="blank5"></div>
    <div style="text-align:center; position:relative; width:100%;">
         <?php if ($this->_var['prev_good']): ?>
      <a style="display:none;" href="<?php echo $this->_var['prev_good']['url']; ?>"><img style="position: absolute; left:0;" alt="prev" src="themes/ecmoban_jindong2013/images/up.gif" /></a>
      <?php endif; ?>
      <a href="javascript:;" onclick="window.open('gallery.php?id=<?php echo $this->_var['goods']['goods_id']; ?>'); return false;"><img alt="zoom" src="themes/ecmoban_jindong2013/images/zoom.gif" /></a>
      <?php if ($this->_var['next_good']): ?>
      <a style="display:none;" href="<?php echo $this->_var['next_good']['url']; ?>"><img style="position: absolute;right:0;"  alt="next" src="themes/ecmoban_jindong2013/images/down.gif" /></a>
      <?php endif; ?>
      </div>
...
?>
      ...
      <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="ljgm">立即购买</a>
      <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)" class="jrsc">加入收藏</a>
      </li>
...
?>
	        <tr>
	          <td bgcolor="#FFFFFF" align="left" width="30%">[<?php echo htmlspecialchars($this->_var['property']['name']); ?>]</td>
...
?>
          ...
          <strong><?php echo $this->_var['lang']['then_old_price']; ?></strong><font class="shop"><?php echo $this->_var['package_goods']['saving']; ?></font><br />
					...
					<td bgcolor="#FFFFFF">
					<a href="javascript:addPackageToCart(<?php echo $this->_var['package_goods']['act_id']; ?>)" style="background:transparent"><img src="themes/ecmoban_jindong2013/images/bnt_buy_1.gif" alt="<?php echo $this->_var['lang']['add_to_cart']; ?>" /></a>
					</td>
				</tr>
	    </table>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>

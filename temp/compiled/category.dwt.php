...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_65343700_1502327109');$this->_foreach['filter_na'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_na']['total'] > 0):
    foreach ($_from AS $this->_var['filter_attr_0_65343700_1502327109']):
...
?>
      <div class="good_list_box clearfix" <?php if (($this->_foreach['filter_na']['iteration'] == $this->_foreach['filter_na']['total'])): ?>style="border-bottom:none;"<?php endif; ?>>
			<div class="g_l_b_l"><?php echo htmlspecialchars($this->_var['filter_attr_0_65343700_1502327109']['filter_attr_name']); ?>：</div>
            <div class="g_l_b_r">
			<?php $_from = $this->_var['filter_attr_0_65343700_1502327109']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):

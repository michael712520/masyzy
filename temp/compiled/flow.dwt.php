...
?>
  ...
  <div class="flowBox">
    <div class="spxq_2"><span><?php echo $this->_var['lang']['goods_list']; ?></span></div>
...
?>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td bgcolor="#ffffff"><a href="./" class="jxgw">继续购物</a></td>
            <td bgcolor="#ffffff" align="right"><a href="flow.php?step=checkout" class="jszx">结算中心</a></td>
          </tr>
        </table>
  ...
  <div class="flowBox">
    <div class="spxq_2"><span><?php echo $this->_var['lang']['label_collection']; ?></span></div>
    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
...
?>
            <ul class="clearfix">
              ...
              <li>
                ...
                <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/ecmoban_jindong2013/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
              </li>
            </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/ecmoban_jindong2013/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="submit" name="submit" value="提交订单" class="flow_Submit_wz"/>

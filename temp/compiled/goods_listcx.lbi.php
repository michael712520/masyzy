<div class="box" style="margin-top: 10px;">
  ...
  <span><?php echo $this->_var['lang']['btn_display']; ?>：</span>
  <a href="javascript:;" onClick="javascript:display_mode('list')" style="display:none;"><img src="themes/ecmoban_jindong2013/images/display_mode_list<?php if ($this->_var['pager']['display'] == 'list'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['list']; ?>"></a>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')" style="display:none;"><img src="themes/ecmoban_jindong2013/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a>&nbsp;&nbsp;
     
  <a href="categorycx.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=goods_id&order=<?php if ($this->_var['pager']['sort'] == 'goods_id' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#goods_list" <?php if ($this->_var['pager']['sort'] == 'goods_id'): ?>class="sp_tab_h"<?php else: ?>class="sp_tab"<?php endif; ?>><?php echo $this->_var['lang']['sort']['goods_id']; ?></a>
 <a href="categorycx.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=shop_price&order=<?php if ($this->_var['pager']['sort'] == 'shop_price' && $this->_var['pager']['order'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>#goods_list" <?php if ($this->_var['pager']['sort'] == 'shop_price'): ?>class="sp_tab_h"<?php else: ?>class="sp_tab"<?php endif; ?>><?php echo $this->_var['lang']['sort']['shop_price']; ?></a>
  <a href="categorycx.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=last_update&order=<?php if ($this->_var['pager']['sort'] == 'last_update' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#goods_list" <?php if ($this->_var['pager']['sort'] == 'last_update'): ?>class="sp_tab_h"<?php else: ?>class="sp_tab"<?php endif; ?>><?php echo $this->_var['lang']['sort']['last_update']; ?></a>
...
?>
    ...
    <?php endif; ?>
     ...
     <div>
     <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" ><img src="themes/ecmoban_jindong2013/images/goumai.gif"></a>
    <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);"><img src="themes/ecmoban_jindong2013/images/shoucang.gif"></a> 
    ...
    <?php if ($this->_var['goods']['goods_id']): ?>
     ...
     <?php endif; ?>
           ...
           <p><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo htmlspecialchars($this->_var['goods']['name']); ?></a></p>
            <?php if ($this->_var['goods']['promote_price'] != ""): ?>
           <font class="shop_zs"><?php echo $this->_var['goods']['promote_price']; ?></font>
            <?php else: ?>
           <font class="shop_zs"><?php echo $this->_var['goods']['shop_price']; ?></font>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>

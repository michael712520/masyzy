...
$_LANG['email'] = 'Email地址';
$_LANG['enter_admin_pwd'] = '管理员新';
$_LANG['confirm_admin_pwd'] = '管理员确认';
$_LANG['get_newpassword'] = '管理员找回';
...
$_LANG['js_languages']['admin_pwd_empty'] = '请输入管理员新!';
$_LANG['js_languages']['confirm_pwd_empty'] = '请输入管理员确认!';
$_LANG['js_languages']['both_pwd_error'] = '您两次输入的不一致!';
...
$_LANG['update_pwd_success'] = '您的新已修改成功！';
$_LANG['update_pwd_failed'] = '修改新失败！';

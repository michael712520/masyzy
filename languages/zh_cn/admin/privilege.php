...
$_LANG['forget_pwd'] = '您忘记了吗?';
$_LANG['get_new_pwd'] = '找回管理员';
$_LANG['pwd_confirm'] = '确认';
$_LANG['new_password'] = '新';
$_LANG['old_password'] = '旧';
$_LANG['agency'] = '负责的办事处';
$_LANG['self_nav'] = '个人导航';
...
$_LANG['pwd_error'] = '输入的旧错误!';
$_LANG['old_password_empty'] = '如果要修改,必须先输入你的旧!';
...
/* 帮助信息 */
$_LANG['password_notic'] = '如果要修改,请先填写旧,如留空,保持不变';
$_LANG['email_notic'] = '输入管理员的Email邮箱,必须为Email格式';
$_LANG['confirm_notic'] = '输入管理员的确认,两次输入必须一致';

/* 登录表单 */
$_LANG['label_username'] = '管理员姓名：';
$_LANG['label_password'] = '管理员：';
